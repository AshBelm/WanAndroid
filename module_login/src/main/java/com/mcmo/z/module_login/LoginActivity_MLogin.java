...
import com.mcmo.z.module_login.fragment.LoginFragment;
...
public class LoginActivity_MLogin extends BaseActivity<LoginView_MLogin> {
    ...
    @Override
    public AbsPresenter<LoginView_MLogin> providerPresenter() {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fragmentMap.put(TAG_LOGIN, RouteCons.Login.LOGIN_FRAGMENT);
        fragmentMap.put(TAG_REGISTER, RouteCons.Login.REGISTER_FRAGMENT);
    ...
    public void onBackPressed() {
        if (mCurFragment.getTag().equals(TAG_REGISTER)) {
            changeFragmentToLogin();
        } else {
            super.onBackPressed();
        }
